...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ClientThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 55, 23)
    ...
    "ClientThread\0accessCodeReceived\0\0data\0"
    "sendDataToClient\0sendDinieAccessToClient\0"
};
...
void ClientThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendDataToClient(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientThread::accessCodeReceived)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ClientThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ClientThread.data,
      qt_meta_data_ClientThread,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void ClientThread::accessCodeReceived(const QString & _t1)
{
